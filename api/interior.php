                ...
                <ul class="nav-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="interior.php" class="active">Interior</a></li>
    ...
    <div class="container">
        ...
        <div class="offer-grid">
            <div class="offer-card">
                ...
                <p>At our company we specialize in creating elegant and functional modular kitchens tailored to your unique lifestyle and needs exceptional modular kitchen designs.</p>
            </div>

            <div class="offer-card">
                <h3>Modular Wardrobes</h3>
                <p>At our company we specialize in crafting elegant and functional modular wardrobes that cater to your storage needs while enhancing the aesthetic appeal of your space.</p>
            </div>

            <div class="offer-card">
                <h3>Lighting & Electrical Works</h3>
                <p>At our company we believe that lighting is not just about illumination; it's about creating an ambiance that enhances your living space Upgrading electrical wiring.</p>
            </div>

            <div class="offer-card">
                <h3>Flooring & False ceiling</h3>
                <p>At our company we understand that the right Flooring & False ceiling can transform a space from ordinary to extraordinary considerations for the ceiling.</p>
            </div>
        </div>
    </div>
</section>
